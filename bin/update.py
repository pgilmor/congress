...
gitBashCommand = "git init && git config user.name {} && git config user.email {} && git config github.user {} && git config github.token {}".format(name, email, githubUser, token)
print gitBashCommand
